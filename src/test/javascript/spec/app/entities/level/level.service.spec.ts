  ...
  describe('Level Service', () => {
    ...
    describe('Service methods', () => {
      it('should call correct URL', () => {
        ...
        const resourceUrl = SERVER_API_URL + 'api/levels';
        expect(req.request.url).toEqual(resourceUrl + '/' + 123);
      });

      it('should create a Level', () => {
        service.create(new Level(null)).subscribe(received => {
      ...
      it('should update a Level', () => {
        service.update(new Level(123)).subscribe(received => {
