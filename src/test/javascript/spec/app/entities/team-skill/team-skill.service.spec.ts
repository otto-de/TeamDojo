  ...
  describe('TeamSkill Service', () => {
    ...
    describe('Service methods', () => {
      it('should call correct URL', () => {
        ...
        const resourceUrl = SERVER_API_URL + 'api/team-skills';
        expect(req.request.url).toEqual(resourceUrl + '/' + 123);
      });

      it('should create a TeamSkill', () => {
        service.create(new TeamSkill(null)).subscribe(received => {
      ...
      it('should update a TeamSkill', () => {
        service.update(new TeamSkill(123)).subscribe(received => {
