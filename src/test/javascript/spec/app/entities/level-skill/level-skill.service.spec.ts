...
describe('Service Tests', () => {
  describe('LevelSkill Service', () => {
    ...
    beforeEach(() => {
      ...
      injector = getTestBed();
      service = injector.get(LevelSkillService);
    ...
    describe('Service methods', () => {
      it('should call correct URL', () => {
        ...
        const resourceUrl = SERVER_API_URL + 'api/level-skills';
        expect(req.request.url).toEqual(resourceUrl + '/' + 123);
      });

      it('should create a LevelSkill', () => {
        service.create(new LevelSkill(null)).subscribe(received => {
      ...
      it('should update a LevelSkill', () => {
        service.update(new LevelSkill(123)).subscribe(received => {
