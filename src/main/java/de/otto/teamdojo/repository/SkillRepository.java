...
public interface SkillRepository extends JpaRepository<Skill, Long>, JpaSpecificationExecutor<Skill> {
    ...
    @Query("SELECT DISTINCT" +
        " new de.otto.teamdojo.service.dto.AchievableSkillDTO(t.id, s.id, s.title, s.description, t.completedAt, t.verifiedAt, t.vote, t.irrelevant, s.rateScore, s.rateCount)" +
        " FROM Skill s" +
